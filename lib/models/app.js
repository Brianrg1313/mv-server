...
class AppModel {
    ...
    async getFoodMenu() {
        if (await AppModel.redis.issetInHash(Databases.redis.app, "menu_carta")) {
            return await AppModel.redis.findInHash(Databases.redis.app, "menu_carta")
        }
        ...
        AppModel.redis.insertInHash(Databases.redis.app, "menu_carta", response)
    ...
    #variables = ["id", "es", "en", "subes", "suben", "formato", "coleccion", "icono", "tipo", "abreviacion", "pattern", "posicion", "min", "max"]
    get variables() {
        return ["id", "titulo", "subtitulo", "formato", "visible", "coleccion", "icono", "tipo", "abreviacion", "pattern", "posicion", "min", "max"]
    }
