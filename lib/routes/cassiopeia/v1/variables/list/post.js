...
module.exports = async (context) => {
    ...
    return context.finish({
        id: data.id,
        icon: null,
        title: data[context.headers["accept-language"]],
        caption: data["sub" + context.headers["accept-language"]],
        flag: data.bandera,
        type: data.tipo,
        format: data.formato,
        reference: data.referencia,
        collection: data.coleccion,
        abbreviation: intToAbc(data.abreviacion),
        position: null
    })
}
