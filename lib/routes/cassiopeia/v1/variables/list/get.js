...
module.exports = async (context) => {
    ...
    const response = {
        ...
        variables: {
            claves: ["id", "icon", "title", "caption", "flag", "type", "format", "reference", "collection", "abbreviation", "position"],
            valores: []
        }
    }

    const dbKeys = ["id", "icono", "titulo", "subtitulo", "bandera", "tipo", "formato", "referencia", "coleccion", "abreviacion", "posicion"]
